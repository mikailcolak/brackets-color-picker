	...
	*/
	...
	Iris = {
		options: {
			...
			width: 174, // the width of the collection of UI elements
			palettes: false, // show a palette of basic colors beneath the square.
			alphaSlider: true, // show a slider for alpha channel
			onchange: false // callback function for color selection event
		},
		_color: '',
		_alpha: 1.0,
		...
		_change: function() {
			...
			$('.alphaSlider > span').css('background-color', self.options.color);

			if ( self.options.onchange !== false && typeof( self.options.onchange ) === 'function' ) {
				self.options.onchange(self.options.color);
			}
		...
		clear: function() {
			...
			this.options.color = this._color.toString();
			this.element.val('');
		},
